        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item">
                    ...
                    <?php else: ?>
                        <a class="page-link" href="?is_reply=1&paginate=<?php echo $paginate->now - 1; ?>" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                            <span class="sr-only">Previous</span>
                        </a>
                    <?php endif; ?>
                ...
                <li class="page-item">
                    ...
                    <?php else: ?>
                        <a class="page-link" href="?is_reply=1&paginate=<?php echo $paginate->now + 1; ?>" aria-label="Next">
                            <span aria-hidden="true">&raquo;</span>
                            <span class="sr-only">Next</span>
                        </a>
                    <?php endif; ?>

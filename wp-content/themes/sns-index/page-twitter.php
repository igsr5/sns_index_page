    ...
    <div class="row head mt-4 pb-3">
        <div class="col-sm-7">
            ...
            <?php if (!$_GET["is_reply"]): ?>
                <a href="?is_reply=1&user_name=<?php echo $twitter_name; ?>">Includeing other users' posts</a>
            <?php else: ?>
                <a href="?is_reply=0&user_name=<?php echo $twitter_name; ?>">Only users' posts</a>
            <?php endif; ?>
            <a class="ml-2" href="<?php echo home_url('/users'); ?>">Index</a>
        </div>
